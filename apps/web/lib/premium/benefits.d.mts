...
export function selectPlaybackAuthorizationPrefix(pathPrefix: string, selectedMediaPath: string, format: string | null | undefined, enhancedQuality: boolean): string;

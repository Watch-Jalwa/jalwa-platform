...
export const featuredContent: CatalogueItem[] = [
  ...
  {
    slug: "nasa-live-space-stream",
    title: "NASA Live: space and mission coverage",
    description: "Official NASA live coverage used to exercise Jalwa's live-content presentation.",
    category: "Live",
    categorySlug: "live",
    accessLevel: "public",
    contentType: "live",
    hostingMode: "embed_only",
    thumbnailUrl: youtubeThumbnail("21X5lGlDOfg"),
    playback: youtubePlayback("21X5lGlDOfg"),
    sourceUrl: "https://www.youtube.com/watch?v=21X5lGlDOfg",
    attribution: "Embedded from NASA's official YouTube live stream.",
  },
  {

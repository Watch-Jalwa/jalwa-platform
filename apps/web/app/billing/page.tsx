...
export default async function BillingPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return <div className="page-shell billing-page">
    <div className="section-heading"><div><span className="eyebrow">Account</span><h1>Billing</h1></div><div className="billing-header-actions"><Link className="button button-secondary" href="/premium">Premium benefits</Link><Link className="button button-primary" href="/pricing">View plans</Link></div></div>

...
import { getPaymentServicePayments } from "@/lib/payments/payment-service";
...
export async function GET() {
  ...
  try {
    return NextResponse.json(await getPaymentServicePayments(userId), { headers: { "Cache-Control": "no-store" } });
  } catch (error) {

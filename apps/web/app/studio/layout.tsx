  ...
  return (
    <div className="studio-shell">
      <aside className="studio-nav">
        ...
        <nav><Link href="/studio">Overview</Link><Link href="/studio/content">Content</Link><Link href="/studio/content/new">Add content</Link>{canOperateMedia ? <><Link href="/studio/live">Live operations</Link><Link href="/studio/drm">Protected media</Link></> : null}{canModerate ? <Link href="/studio/moderation">Moderation</Link> : null}<Link href="/studio/operations">Operations</Link>{canViewSupport ? <Link href="/studio/support">Support</Link> : null}{canViewFinance ? <Link href="/studio/finance">Finance</Link> : null}<Link href="/">View Jalwa</Link></nav>
      </aside>
